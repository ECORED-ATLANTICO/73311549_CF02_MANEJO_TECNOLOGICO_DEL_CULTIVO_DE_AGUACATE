...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
            ...
            .tarjeta.bg-01.p-3
              .row.justify-content-center.align-items-center.my-lg-4.p-1
                .col-md-12.col-xl-8.mb-4
                  h3.mb-2 Textura
                  p Esta especie se adapta a diferentes tipos de suelo, desde lo arenoso y suelto hasta franco limoso y compacto (las arcillas no pueden superar el 28 %, pues se puede ver afectado el desarrollo radicular del árbol o problemas de pudrición y enfermedades fungosas). Sin embargo, los mejores rendimientos se obtienen en suelos permeables y bien drenados, de textura franca y estructura o consistencia media con alto contenido de materia orgánica. 
    ...
    .row.justify-content-center.align-items-center.mb-1
      ...
      .col-lg-12.mb-4
        p En general en los trópicos la poda estimula el crecimiento vegetativo en detrimento de la floración, por lo que en la mayoría de las ocasiones se limita la poda a una limpieza de ramas secas, mal formadas o distribuidas. En la variedad 
          i Hass 
          | se tiene como técnica podar las ramas de la parte superior de la copa de los árboles, con el fin de equilibrar la producción y regular la alternancia de cosechas.
    ...
    .row.justify-content-center.align-items-center.mb-2
      .col-lg-10      
        ...
        .row.justify-content-center.align-items-center
          .col-lg-8.mb-2
            p.mb-3 Poda de mantenimiento: una vez que la etapa productiva se ha iniciado, no deben hacerse podas muy drásticas o fuertes que lleven a desequilibrar la planta y genere una baja floración, conllevando a la disminución en la producción. Generalmente esta consiste en cortar las ramas pegadas al suelo, tallos enfermos, ramas secas y brotes muertos. En esta labor, se tiene que ser muy cuidadoso con las herramientas, las cuales deben ser desinfectadas al igual que las áreas cortadas del árbol y protegidas con pinturas, fungicidas e insecticidas.
    ...
    .row.justify-content-center.align-items-center.mb-1
            ...
            .col-lg-8.mb-3
              AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta acordeonA")
                ...
                .row(titulo="Calcio (Ca)")
                  .col-12
                    p.mb-0 Este elemento da estabilidad a la planta, formando estructuras rígidas de soporte, además de protección al ingreso de insectos plagas y enfermedades en el árbol. Es determinante en la estabilidad y calidad del fruto. El exceso puede generar desbalances y deficiencias de otros elementos como el magnesio (Mg) y el potasio (K). La deficiencia se observa en la detención del crecimiento, las hojas se enroscan y empiezan a secarse por las puntas y bordes, y se incrementa la susceptibilidad a pudriciones.
      ...
      .col-lg-10.mb-2
        .titulo-sexto.bg-11.mb-4
            h5 Tabla 2. 
            span.text-dark 
              i Niveles nutricionales en las hojas del aguacate
      ...
      .col-md-10.col-lg-6.mb-2
        .titulo-sexto.bg-11.mb-4
            h5 Tabla 3. 
            span.text-dark 
              i Extracción de nutrientes en fruta fresca de aguacate, de árboles en plena producción
        ...
        SlyderF.custom.mb-5(columnas="col-lg-6 col-xl-6")
          .tarjeta.tarjeta--slyder.p-4
            .row.justify-content-center.mb-3
              .col-8.bg-04
                h4.p-1.text-white.text-center Cucarrón marceño o chiza 
                  i (Phyllophaga obsoleta)
    ...
    .row.justify-content-center.align-items-center.mb-3
      ...
      .col-lg-8.mb-3
        LineaTiempoD.color-primario.text-small
          ...
          .row(numero="4" titulo="Escamas protegidas <em>(Saissetia oleae y Chrysomphalus dictyospermi)</em>")
            .col-md-12.mb-4.mb-md-0
          ...
          .row(numero="5" titulo="<em>Chinche Monalonion (Monalonion Dissimulatum)</em>")
            .col-md-12.mb-4.mb-md-0
          ...
          .row(numero="6" titulo="Gusano pega – pega o bicho candela <em>(Platynota sp)</em>")
            .col-md-12.mb-4.mb-md-0
      ...
      .col-lg-8.mb-3
        LineaTiempoD.color-primario.text-small
          .row(numero="7" titulo="Gusano canasta <em>(Oiketicus kirbyi)</em>")
            .col-md-12.mb-4.mb-md-0
              p El daño de este insecto se distingue por la defoliación severa de cogollos, la cual está acompañada por la presencia de canastas alargadas en forma de tabaco, elaboradas por las larvas con trozos de hojas y filamentos sedosos. Es un gran comedor de hojas y sus daños son bastante notorios. El control biológico para este insecto tiene muy buenos resultados con la bacteria <em>Bacillus thuringiensis</em>.
          
          .row(numero="8" titulo="Gusano comedor de hojas, Gusano barba de indio <em>(Megalopyge orsíloco)</em>, Gusano pollo <em>(Megalopyge lanata)</em> y gusano perro del naranjo <em>(Anchisiades papilio)</em>")
            .col-md-12.mb-4.mb-md-0
          ...
          .row(numero="11" titulo="Perforador del fruto <em>(Stenoma catenifer)</em>")
            .col-md-12.mb-4.mb-md-0
          ...
          .row(numero="12" titulo="Picudo del aguacate <em>(Heilipus lauri y Heilipus pittieri)</em>")
            .col-md-12.mb-4.mb-md-0
    ...
    .row.justify-content-center.align-items-center.mb-1.ordenar_tarjeta_lg
      ...
      .col-lg-12.mb-2
        h4 Pudrición de la raíz o marchitez del aguacate <em>(Phytophthora cinnamomi)</em>:
        ...
        .tarjeta.fondo_1_2.p-4.slyder_1.bg-01
          SlyderA(tipo="b").tarjeta--blanca
            ...
            .tarjeta.bg-01.p-2
              .row.ordenar_tarjeta.justify-content-center.align-items-center.my-lg-4.p-3
                .col-md-12.col-xl-10.mb-4
                  h3.mb-2 Mancha angular o mancha negra <em>(Cercospora purpurea)</em>:
                  p La enfermedad se agrava en condiciones de alta precipitación y baja nutrición, afectando principalmente las hojas medias y bajas del árbol, con lesiones marrón oscuro que pueden causar defoliación. En los frutos, provoca lesiones oscuras y resquebrajamiento de la corteza, conocidas como mancha angular, además de la mancha negra en poscosecha. Estas lesiones facilitan la entrada de organismos como <em>Colletotrichum</em>. Para su control, se recomiendan aspersiones racionales de fungicidas a base de cobre.
            ...
            .tarjeta.bg-01.p-2
              .row.ordenar_tarjeta.justify-content-center.align-items-center.my-lg-4.p-3
                .col-md-12.col-xl-10.mb-4
                  h3.mb-2 Mancha negra o antracnosis <em>(Colletotrichum gloeosporioides)</em>:
    ...
    .row.justify-content-center.align-items-center
      ...
      .col-lg-12.mb-2
        p.mb-3 Después de establecido el cultivo y cuando los árboles han desarrollado una gran copa se pueden manejar algunas arvenses dentro de la plantación. Cuando se realiza el control de arvenses debe evitarse el empleo de herramientas cortantes cerca del tallo de los árboles para no provocar heridas que pueden ser la entrada para el hongo causante de la marchitez del aguacate <em>Phytophthora cinnamomi</em>.
